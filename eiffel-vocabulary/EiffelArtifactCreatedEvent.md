<!---
   This file was generated from ../definitions/EiffelArtifactCreatedEvent/4.0.2.yml.
...
| ------- | ------------- | ------- |
| 4.0.2 | Not yet released in an edition | Detail the expected representation of public key and signature in meta.security  (see [Issue 375](https://github.com/eiffel-community/eiffel/issues/375)). |
