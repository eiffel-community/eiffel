...
1. Always explicitly connect a pull request to an Issue. See [How to Propose Changes](./introduction/how-to-propose-changes.md) for further information.
...
1. All members of the Eiffel team are expected to make the effort to participate in the review of Pull Requests. Every member may not review everything in detail, but everyone can make the effort to chime in on some. Remember that an expedient high quality reviews are crucial to the long term survival of any open source project.
